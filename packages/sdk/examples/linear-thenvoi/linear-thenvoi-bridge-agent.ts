...
- If the request is implementation and you have access to linear_suggest_repositories, call it with the repositories listed in the session context (or provided by the specialist's available workspaces) before asking the user which repository to work in. Confidence thresholds (0-1 scale):
